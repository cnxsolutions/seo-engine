...
// callers averaged them. The word "published" covered four different states —
// committed to a branch nobody deploys, saved as a WordPress draft, live and
// reachable, live and in the sitemap — and the engine recorded all four the same
...
//   discoverable something points at it — a sitemap entry, a link. Live without
...
export interface PublishRequest {
   ...
   *
   * The database is the reference for "did I write here?" — it answers without
  ...
  /**
   * Bypass the OCCUPANCY and REDIRECT guards — never the quality gate.
   *
   ...
   *
   * Set by the reaper's recovery path. It does not lift the occupancy guard —
...
export interface PublishOutcome {
  ...
  pageUrl?: string
  /** The destination's own identifier — a WordPress post id, for instance. */
  remoteId?: string
